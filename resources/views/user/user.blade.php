...
<body class="font-sans">
  ...
  <div class="relative w-full h-64 mt-16">
    ...
    <form action="" method="POST" class="absolute bottom-2 right-10" enctype="multipart/form-data">
      <label for="edit-banner" class="px-3 py-1 text-sm border shadow-md cursor-pointer text-darkBlue border-darkBlue bg-gray-50">
        Change Picture
      </label>
      <input accept="image/*" type="file" class="hidden" id="edit-banner" name="banner" onchange="form.submit()">
    </form>
  </div>
  ...
  <main class="px-4 -mt-20 lg:px-16">
    <section class="flex flex-col items-center justify-center text-center">
      ...
      <h4 class="mb-4 text-lg">Adress</h4>
      <a href="#">085858055</a>
       <!-- Modal Edit User -->
            ...
            <form action="#" class="w-full">
              ...
              <div class="relative mb-5 float-input">
                <input 
                  ...
                  placeholder="Adress" 
                />
                <label for="email" class="absolute top-0 left-0 h-full px-3 py-4 text-gray-400 transition-all duration-100 ease-in-out origin-left transform pointer-events-none ">Your Adress</label>
              </div>
              <div class="relative mb-5 float-input">
                <input 
                  type="number" 
              ...
              <form action="#" class="w-full">
                ...
                <div class="relative mb-5 float-input">
                  <input 
                    ...
                    id="Adress" 
                    class="w-full p-3 text-gray-600 bg-gray-100 border-none rounded-md h-14 focus:outline-none" 
                    placeholder="Store's Adress" 
                  />
                  <label for="email" class="absolute top-0 left-0 h-full px-3 py-4 text-gray-400 transition-all duration-100 ease-in-out origin-left transform pointer-events-none ">Store's Adress</label>
                </div>
                <div class="mb-5">
                  <textarea 
