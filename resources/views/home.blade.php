        ...
        <section class="px-3 mt-20 lg:px-16">
            <div class="overflow-x-scroll lg:overflow-x-auto" id="swipe">
                <div class="flex gap-4 lg:gap-9" x-data="{ status: 'all' }">
                    ...
                    <button class="px-3 py-1 text-xs shadow-sm lg:text-sm" @click="status = 'fashion'"
                        :class="status === 'fashion' ? 'text-white bg-crayola' : 'text-crayola border border-crayola'">
                        Fashion
                    </button>
                    <button class="px-3 py-1 text-xs shadow-sm lg:text-sm" @click="status = 'electronic'"
                        :class="status === 'electronic' ? 'text-white bg-crayola' : 'text-crayola border border-crayola'">
                        Electronic
                    </button>
                    <button class="px-3 py-1 text-xs shadow-sm lg:text-sm" @click="status = 'school'"
                        :class="status === 'school' ? 'text-white bg-crayola' : 'text-crayola border border-crayola'">
                        School
                    </button>
                    <button class="px-3 py-1 text-xs shadow-sm lg:text-sm" @click="status = 'accessories'"
                        :class="status === 'accessories' ? 'text-white bg-crayola' : 'text-crayola border border-crayola'">
                        Accessories
                    </button>
                    <button class="px-3 py-1 text-xs shadow-sm lg:text-sm" @click="status = 'furniture'"
                        :class="status === 'furniture' ? 'text-white bg-crayola' : 'text-crayola border border-crayola'">
                        Furniture
                    </button>
                    <button class="px-3 py-1 text-xs shadow-sm lg:text-sm" @click="status = 'art'"
