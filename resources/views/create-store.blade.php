    ...
    <section class="flex items-center w-full px-5 bg-white lg:mx-auto lg:w-3/5">
      <form action="#" class="w-full">
        ...
        <div class="relative mb-5 float-input">
          ...
          />
          <label for="location" class="absolute top-0 left-0 h-full px-3 py-4 text-gray-400 transition-all duration-100 ease-in-out origin-left transform pointer-events-none ">Location</label>
        </div>
